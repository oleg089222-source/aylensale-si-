/**
 * GET /api/manifest-csv?id=prod_xxx|auction_xxx&type=product|auction
 * Public manifest download for B2B buyers (active listings only).
 */
import { getFirestoreAdmin } from '../lib/server/firebase-admin-app.mjs';
import { manifestToCsv } from '../lib/server/manifest-export.mjs';
